---
permalink: /4.0.98.2.html
title: Release Notes v4.0.98.2
...
* Issues
  * closes #35 - MIR (Мир) 4.0.98.0-alpha `<Alpha 0>`
  * closes #36 - MIR (Мир) 4.0.98.1-alpha `<Alpha 1>`
  * closes #40 - MIR (Мир) 4.0.98.2-beta `<Beta 0>`
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/MIR%20(MIR)%20-v4.0.98.2--beta-BADA55.svg?style=plastic&labelColor=darkgreen/ "4.0.98.2-beta"
